...
class myEnv_2weekly_varyaction_vax(gym.Env):
	
	metadata = {'render.modes':['human']}
	
	def __init__(self, N, initial_state, alpha1, alpha2, alpha_linear, num_actions, vaccine_startdate):
		super(myEnv_2weekly_varyaction_vax, self).__init__()
